                        ...
                        <div class="d-flex flex-column h-100">
                            ...
                            <div class="auth-content my-auto">
                                <div class="text-center">
                                    ...
                                    <p class="text-muted mt-2">{{ __('Login') }}</p>
                                </div>
                                <form class="custom-form mt-4 pt-2" method="POST" action="{{ route('authenticate') }}">
                                 @csrf
                                    <div class="mb-3">
                                ...
                                @enderror
                                    ...
                                    <div class="mb-3">
                                        <button class="btn btn-primary w-100 waves-effect waves-light" type="submit" href="{{ route('dashboard') }}">{{ __('Login') }}</button>
...
<script>
    // Add sounds for each slide
    const sounds = [
        new Audio('path_to_your_sound_file1.mp3'), // Sound for slide 1
        new Audio('path_to_your_sound_file2.mp3'), // Sound for slide 2
        new Audio('path_to_your_sound_file3.mp3'), // Sound for slide 3
    ];

    const carousel = document.querySelector('#reviewcarouselIndicators');
    const carouselItems = document.querySelectorAll('.carousel-item');

    // Play sound when the slide changes
    carousel.addEventListener('slid.bs.carousel', function (event) {
        const index = event.to; // Get the index of the active slide
        sounds[index].play();  // Play the sound corresponding to the active slide
    });
</script>
@endsection
