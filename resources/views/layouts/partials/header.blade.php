        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <a class="dropdown-item" href="javascript:void(0)"><i class="mdi mdi mdi-face-man font-size-16 align-middle me-1"></i> My Account</a>
                    <a class="dropdown-item" href="javascript:void(0)"><i class="mdi mdi-lock font-size-16 align-middle me-1"></i> Lock Screen</a>
                    <a class="dropdown-item" href="javascript:void(0)"><i class="mdi mdi-logout font-size-16 align-middle me-1"></i> Logout</a>
                </div>
            </div>
